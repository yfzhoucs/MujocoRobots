...
mean_gripper = mean_joints[-1]
std_gripper = std_joints[-1]
...
if __name__ == '__main__':
    ...
    # Load model
    model = Backbone(img_size=224, embedding_size=192, num_traces_in=8, num_traces_out=10, num_weight_points=12, input_nc=3, device='cpu')
    ...
    interface.connect(joint_names=['panda0_joint1', 'panda0_joint2', 'panda0_joint3', 'panda0_joint4', 'panda0_joint5', 'panda0_joint6', 'panda0_joint7', 'panda0_finger_joint1'], camera_id=0)
