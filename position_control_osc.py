...
# robot_config = arm('ur5.xml', folder='./my_models/ur5_abr/')
...
# init = np.concatenate((robot_config.START_ANGLES, np.array([0.2, 0.3, 0.5, 0, 0, 0, 0])))
...
try:
    ...
    while 1:
        ...
        # print("target2", interface.get_xyz("target2"))
        # print(interface.sim.data.qpos)
        # interface.sim.data.qpos[-6] = interface.sim.data.qpos[-6] + 0.0001
