...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/share/yzhou298/ckpts/extended_modattn/put_right_to/train-rgb-sub-attn-abs-action-separate-tar2-nets-vision-embed/840000.pth')['model'], strict=True)
    model.eval()


    chkpt_dir='./models/mae_pretrain_vit_large.pth'
    ...
    while True:
        # sentence = input('please input instruction: ')
        sentence = 'put pepsi right to coke'
        ...
        while i < t_lim:
            ...
            ee_pos, target_pos, phis, img, joint_angles = get_inputs(target_name, interface, e, mean, std, mean_joints, std_joints)
