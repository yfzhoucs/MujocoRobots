...
if __name__ == '__main__':
    ...
    # e.append(MoveTo(interface, ctrlr, target_func, gripper_control_func, error_limit=0.2))
    ...
    # e.append(MoveTo(interface, ctrlr, target_func_4, gripper_control_func, time_limit=1000000))
    # e.execute()

    e = Executor(interface, robot_config.START_ANGLES, -0.05)
    e.append(MoveTo(interface, ctrlr, target_func, gripper_control_func_2, error_limit=0.05))
    e.append(MoveTo(interface, ctrlr, target_func_2, gripper_control_func, time_limit=100))
    # e.append(MoveTo(interface, ctrlr, target_func_3, gripper_control_func_2, time_limit=25))
    # e.append(MoveTo(interface, ctrlr, target_func_4, gripper_control_func, time_limit=1000000))
    e.execute()